# http://code.activestate.com/recipes/577735/
import sys
...
def expectation_maximization(t, nbclusters=2, nbiter=3, normalize=False,\
    ...
    """ 
    (numpy.array, int, int, bool, float, bool, bool) -> (dictionary)
    ...
    'normalize' normalize features (subtract min and divide by range)
    ...
    -> Compute E_t=Sum_{obs} log(P(obs)^t)
       Repeat Steps 2 and 3 until |E_t - E_{t-1}| < eps
    """
    def pnorm(x, m, s):
        """ 
